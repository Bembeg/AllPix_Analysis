...
# RunAnalysis("0deg-290um-athena-cut10_output.root", "0deg-290um-athena-cut10_analysed.root", source="athena", CT_StS=0.0, CT_StBP=0.0)
# RunAnalysis("0deg-290um-athena-cut1_output.root", "0deg-290um-athena-cut1_analysed.root", source="athena", CT_StS=0.0, CT_StBP=0.0)

RunAnalysis("test_output.root", "test_analysed.root", source="athena", CT_StS=0.0, CT_StBP=0.0)