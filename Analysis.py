...
def RunAnalysis(inputName, outputName=0, CT_StS=0, CT_StBP=0):
        # path = "/home/b/pCloudDrive/Work/MgrThesis/Prog/AllPix/tb/output/"
        rootFile = TFile("data/" + inputName)
        ...
        print("CONFIG: Sensor:", thickness, ",  Events:", nOfParts, ", scaleXFactor:", scaleXFactor, ", nOfStrips:", nOfStrips,
         ", CT_StS:", CT_StS, ", CT_StBP:", CT_StBP)
